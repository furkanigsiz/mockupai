                    ...
                    <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
                        ...
                        <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-gray-200 dark:border-b-[#283639] px-4 sm:px-10 py-3">
                            <div className="flex items-center gap-4 text-gray-800 dark:text-white">
                                ...
                                <h2 className="text-gray-900 dark:text-white text-lg font-bold leading-tight tracking-[-0.015em]">AI MockupGen</h2>
                            </div>
                            <div className="hidden md:flex flex-1 justify-end gap-8">
                                ...
                                <button onClick={onGetStarted} className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-primary text-gray-900 dark:text-[#111718] text-sm font-bold leading-normal tracking-[0.015em]">
                        ...
                        <main className="flex-1">
                                    ...
                                    <div className="flex flex-col gap-8 px-4 py-10 @[480px]:gap-10 @[864px]:flex-row-reverse">
                                        ...
                                        <div className="flex flex-col gap-6 @[480px]:min-w-[400px] @[480px]:gap-8 @[864px]:justify-center">
                                            ...
                                            <div className="flex-wrap gap-3 flex">
                                                <button onClick={onGetStarted} className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 @[480px]:h-12 @[480px]:px-5 bg-primary text-gray-900 dark:text-[#111718] text-sm font-bold leading-normal tracking-[0.015em] @[480px]:text-base">
                            ...
                            <div className="py-16 sm:py-24">
                                <div className="flex flex-col gap-8 items-center text-center px-4">
                                    ...
                                    <div className="max-w-2xl mx-auto pt-8">
                                        <blockquote className="text-lg italic text-gray-700 dark:text-gray-300">"AI MockupGen has revolutionized how we showcase our products. The quality is incredible, and it saves us countless hours and thousands of dollars on photoshoots."</blockquote>
                            ...
                            <div className="py-16 sm:py-24">
                                <div className="bg-gray-100 dark:bg-[#1c2527] rounded-xl p-10 sm:p-16 flex flex-col items-center text-center gap-6">
                                    ...
                                    <button onClick={onGetStarted} className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-6 bg-primary text-gray-900 dark:text-[#111718] text-base font-bold leading-normal tracking-[0.015em]">
                        ...
                        <footer className="border-t border-gray-200 dark:border-gray-800 py-10 mt-16">
                            <div className="flex flex-col md:flex-row justify-between items-center gap-8 px-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-sm text-gray-600 dark:text-gray-400">© 2024 AI MockupGen. All rights reserved.</span>
                                </div>
